	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("category_create");
				Roles.Public.Grant("category_create");
				Roles.Guest.Grant("category_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("category_load", "category_list");
				Roles.Public.Revoke("category_load", "category_list");
				Roles.Member.Revoke("category_load", "category_list");
				*/
