	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("unit_create");
				Roles.Public.Grant("unit_create");
				Roles.Guest.Grant("unit_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("unit_load", "unit_list");
				Roles.Public.Revoke("unit_load", "unit_list");
				Roles.Member.Revoke("unit_load", "unit_list");
				*/
