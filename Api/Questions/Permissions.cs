	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Public.Grant("question_create");
				Roles.Guest.Grant("question_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("question_load", "question_list");
				Roles.Public.Revoke("question_load", "question_list");
				Roles.Member.Revoke("question_load", "question_list");
				*/
