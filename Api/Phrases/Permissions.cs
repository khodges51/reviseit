	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("phrase_create");
				Roles.Public.Grant("phrase_create");
				Roles.Guest.Grant("phrase_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("phrase_load", "phrase_list");
				Roles.Public.Revoke("phrase_load", "phrase_list");
				Roles.Member.Revoke("phrase_load", "phrase_list");
				*/
